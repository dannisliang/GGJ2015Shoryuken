...
public class DynamicSoundGroupInspector : Editor {
	...
	private DynamicSoundGroupCreator dgsc;
	...
	public override void OnInspectorGUI() {
		...
		dgsc = _previewer.GetComponent<DynamicSoundGroupCreator>();
		if (dgsc != null) {
	...
	public void CreateVariation(DynamicSoundGroup group, AudioClip clip) {
		...
		DynamicSoundGroupCreatorInspector.CopyFromAudioSourceTemplate(dgsc, variation.VarAudio, false);
	}

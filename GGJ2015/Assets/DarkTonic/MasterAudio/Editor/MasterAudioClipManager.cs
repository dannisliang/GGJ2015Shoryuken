	...
	public class MasterAudioClipManager : EditorWindow {
	    ...
	    private void BuildCache() {
	        ...
	        for (var i = 0; i < filePaths.Length; i++) {
				...
				AudioInfo newClip = new AudioInfo(aPath, Path.GetFileNameWithoutExtension(aPath), importer.threeD, bitrate, importer.forceToMono, importer.format, importer.loadType);
